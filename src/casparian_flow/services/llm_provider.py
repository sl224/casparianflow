...
class AnthropicProvider(LLMProvider):
    def __init__(self, api_key: str = None, default_model: str = "claude-3-opus-20240229"):
        import anthropic
...
class manual_provider_placeholder: pass # prevent re-definition error during edit
