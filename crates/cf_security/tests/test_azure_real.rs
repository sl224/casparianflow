...
fn test_credentials_documentation() {
    ...
    if !has_real_credentials() {
        ...
        println!();
        println!("   Then run: cargo test -p cf_security --test test_azure_real -- --ignored --nocapture");
        println!();
    } else {
        println!("\n✓ Azure credentials configured!");
        println!("  Run: cargo test -p cf_security --test test_azure_real -- --ignored --nocapture");
    }
}
