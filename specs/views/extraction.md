...
**Version:** 1.0
**Related:** specs/extraction.md (Extraction API)
...
|-------|------------------|-------|
| `extraction_rules` | id, source_id, name, glob_pattern, tag, priority, enabled, created_by, created_at | May not exist yet |
| `extraction_fields` | id, rule_id, field_name, source_type, source_value, pattern, type_hint, normalizer, default_value | May not exist yet |
