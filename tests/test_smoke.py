...
# NOTE: test_parquet_output_verification and test_sqlite_output_verification removed
# These tests used the old CasparianWorker architecture which has been replaced
# by the Split Plane architecture. Equivalent functionality is tested in:
# - tests/test_generalist_e2e.py (Parquet output)
# - tests/test_generalist_sqlite_e2e.py (SQLite output)
